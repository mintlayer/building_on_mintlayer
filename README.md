...
**TODO** Get a real client here
**TODO** seems like we need to import the utxo module, which comes from test framework...
**TODO** Why does Transaction need a client object? I don't like this
```python
...
- **TODO** Something about LN
**TODO** This section is extremely short
...
From a resource management perspective, allowing multiple source and destination addresses within a single transaction improves performance and saves space on the blockchain. (**TODO** What exactly are we comparing this to? Review again with Ben).
